...
import 'package:project_ai_chat/View/Knowledge/data/knowledge_data.dart';
...
class _KnowledgeScreenState extends State<KnowledgeScreen> {
  ...
  void _openEditKnowledgeDialog(BuildContext context, Knowledge knowledge, int index) {
                ...
                itemBuilder: (context, index) {
                  return Container(
                    ...
                    child: Stack(
                      ...
                      children: [
                        KnowledgeCard(knowledge: _filteredKnowledge[index]),
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              IconButton(
                                ...
                                constraints: const BoxConstraints(),
                                onPressed: () {
                                  _removeKnowledge(_filteredKnowledge[index]);
                                },
