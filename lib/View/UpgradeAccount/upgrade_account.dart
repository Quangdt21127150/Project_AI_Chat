      ...
      child: Column(
        ...
        children: [
          Text(
            ...
            style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: _textColor),
          ),
          const SizedBox(height: 16),
          ...features.map((f) => _buildFeature(f['text'] as String, f['icon'] as IconData)),
        ],
      ),
    );
  }
        ...
        child: AnimatedContainer(
          ...
          child: Row(
            ...
            children: [
              ...
              AnimatedContainer(
                duration: const Duration(milliseconds: 200),
                transform: Matrix4.translationValues(_isHovering ? 5.0 : 0.0, 0.0, 0.0),
